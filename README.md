...
To help with the question of whether a graph of meanders of order *n* under 01 moves is connected, I created a way to draw the entire graph for a given *n*. An example of the result is shown below.<br>
![](https://raw.githubusercontent.com/greg9381/meanders/master/graphics/01moves_n=4.png)