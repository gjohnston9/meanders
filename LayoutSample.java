...
// comment out the setCenter() call farther down        
       // border.setCenter(addGridPane()); ************************************************************************************************************ uncomment for gridPane! (and comment out 'border.setCenter(s1);')
...
// call replaces the grid from the first call        
        ...
        s1.setPrefSize(900, 900);
        s1.setContent(addGridPane());
 ...
 */
    private GridPane addGridPane() {
        ...
        Text category = new Text("Sales:qqq");
        ...
        PerfectMatching pm = new PerfectMatching("101010");
        HashSet<Shape> pmShapes = pmDraw(pm);
...
//        grid.setGridLinesVisible(true);
    ...
    private HashSet<Shape> pmDraw(PerfectMatching pm) {
        ...
        for (int i = 0; i < pm.order()*2; i++) {
            set.add(new Circle(PerfectMatching.x*(i+1) - PerfectMatching.d / 2, 250 - PerfectMatching.d / 2, PerfectMatching.d));
        }
        return set;
    }
